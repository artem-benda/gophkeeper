...
func mustReadConfig() Config {
	...
	flag.StringVar(&config.DatabaseDSN, "d", "postgres://:5432/gophkeeper?sslmode=disable", "Database connection URL in pgx format, for ex. postgres://jack:secret@pg.example.com:5432/mydb?sslmode=verify-ca&pool_max_conns=10")
