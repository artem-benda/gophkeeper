...
func (c *gophKeeperServiceClient) AddSecret(ctx context.Context, in *AddSecretRequest, opts ...grpc.CallOption) (*AddSecretResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
func (UnimplementedGophKeeperServiceServer) AddSecret(context.Context, *AddSecretRequest) (*AddSecretResponse, error) {
